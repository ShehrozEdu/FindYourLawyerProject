...
import { registerLawyerAction } from "../redux/slices/userSlice";
...
export default function LawyerSignup() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(registerLawyerAction(values));
              ...
              <div className="w-full flex-1 mt-8">
                <div className="flex flex-col items-center">
                  ...
                  <button className="w-full max-w-xs font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
                    ...
                    <span className="ml-4">Sign Up with FB</span>
                  </button>
                </div>
                ...
                <div className="mx-auto max-w-xs">
                  <form onSubmit={formik.handleSubmit}>
                    ...
                    <input
                      className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white peer ... mb-0"
                      type="email"
